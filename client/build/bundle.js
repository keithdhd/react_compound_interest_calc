...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  ReactDOM.render(React.createElement(CalculatorBox, null), document.getElementById('calculatorDiv'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalculatorBox = React.createClass({
	  ...
	  setPrincipal: function setPrincipal(e) {
	    this.state.setPrincipal(e.target.value);
	    this.state.compoundInterestForPrincipal();
	    this.forceUpdate();
	  },
	
	  setMonthlyContributions: function setMonthlyContributions(e) {
	    this.state.setMonthlyContributions(e.target.value);
	    this.state.compoundInterestForPrincipal();
	    this.forceUpdate();
	  },
	
	  setYearsToGrow: function setYearsToGrow(e) {
	    this.state.setYearsToGrow(e.target.value);
	    this.state.compoundInterestForPrincipal();
	    this.forceUpdate();
	  },
	
	  setInterestRate: function setInterestRate(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', id: 'currentPrincipal', onChange: this.setPrincipal }),
	      React.createElement(
	        'label',
	        { htmlFor: 'monthlyAddition' },
	        'Monthly Addition: '
	      ),
	      React.createElement('input', { type: 'text', id: 'monthlyAddition', onChange: this.setMonthlyContributions }),
	      React.createElement(
	        'label',
	        { htmlFor: 'yearsToGrow' },
	        'Years To Grow: '
	      ),
	      React.createElement('input', { type: 'text', id: 'yearsToGrow', onChange: this.setYearsToGrow }),
	      React.createElement(
	        'label',
	        { htmlFor: 'interestRate' },
	        'Interest Rate: '
	      ),
	      React.createElement('input', { type: 'text', id: 'interestRate', onChange: this.setInterestRate }),
	      React.createElement(
	        'button',
	        { type: 'submit', onClick: this.calculate },
	        'Calculate'
	      ),
	      React.createElement(
	        'div',
...
/***/ function(module, exports) {
	...
	Calculator.prototype = {
	  ...
	  setPrincipal: function setPrincipal(principal) {
	    this.currentPrincipal = principal;
	  },
	
	  setMonthlyContributions: function setMonthlyContributions(monthlyContribs) {
	    this.monthlyContributions = monthlyContribs;
	  },
	
	  setYearsToGrow: function setYearsToGrow(years) {
	    this.yearsToGrow = years;
	  },
	
	  setInterestRate: function setInterestRate(interest) {
	    this.interestRate = interest;
	  },
	
	  compoundInterestForPrincipal: function compoundInterestForPrincipal() {
